...
const s: Record<string, React.CSSProperties> = {
  ...
  dialog: {
    ...
    borderRadius: 12, padding: 20, width: 340, display: 'flex', flexDirection: 'column', gap: 12,
  ...
  seg: { display: 'flex', gap: 4, background: T.bgElevated, borderRadius: 8, padding: 4 },
  segBtn: {
    display: 'flex', alignItems: 'center', gap: 4, background: 'transparent', border: 'none',
    color: T.textSecondary, fontSize: 12, padding: '0 12px', height: 28, borderRadius: 6, cursor: 'pointer', fontFamily: T.font,
  },
  segActive: { background: T.accent, color: '#fff' },
  select: {
    background: T.bgElevated, border: `1px solid ${T.border}`,
    borderRadius: 6, color: T.text, fontSize: 12, padding: '0 8px', height: 28, outline: 'none', cursor: 'pointer',
  },
  num: {
    width: 60, background: T.bgElevated, border: `1px solid ${T.border}`,
    borderRadius: 6, color: T.text, fontSize: 12, padding: '0 8px', height: 28, outline: 'none',
  },
  toggle: {
    width: 36, height: 20, borderRadius: T.rPill, background: T.bgElevated2,
